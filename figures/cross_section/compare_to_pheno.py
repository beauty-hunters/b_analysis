...
if __name__ == '__main__':
    ...
    h_pred_epos.SetLineWidth(1)
    h_pred_epos.SetMarkerStyle(ROOT.kOpenCross)
    h_pred_epos.SetMarkerSize(1.5)
    ...
    h_pred_ampt_66.SetLineColorAlpha(ROOT.kAzure+6, 0.7)
    h_pred_ampt_66.SetLineWidth(1)
    h_pred_ampt_66.SetLineStyle(1)
    h_pred_ampt_66.SetMarkerStyle(ROOT.kOpenDoubleDiamond)
    h_pred_ampt_66.SetMarkerSize(1.5)
    h_pred_ampt_66.SetMarkerColor(ROOT.kAzure+6)
