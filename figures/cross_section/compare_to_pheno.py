...
if __name__ == '__main__':
    ...
    h_pred_epos.SetLineColor(ROOT.kGreen+2)
    h_pred_epos.SetLineWidth(2)
    h_pred_epos.SetLineStyle(1)
    h_pred_epos.SetMarkerStyle(ROOT.kOpenCross)
    h_pred_epos.SetMarkerSize(1.2)
    h_pred_epos.SetMarkerColor(ROOT.kGreen+2)
    h_pred_epos.SetFillColorAlpha(ROOT.kGreen+2, 1)

    g_pred_ampt_48.SetLineColor(ROOT.kMagenta+2)
    g_pred_ampt_48.SetLineWidth(2)
    g_pred_ampt_48.SetLineStyle(1)
    ...
    h_pred_ampt_48.SetLineStyle(1)
    h_pred_ampt_48.SetMarkerStyle(ROOT.kOpenDiamond)
    h_pred_ampt_48.SetMarkerSize(1.2)
    h_pred_ampt_48.SetMarkerColor(ROOT.kMagenta+2)

    h_pred_ampt_line_48.SetLineColor(ROOT.kMagenta+2)
    h_pred_ampt_line_48.SetLineWidth(2)
    h_pred_ampt_line_48.SetFillStyle(2)
    h_pred_ampt_line_48.SetMarkerSize(0)
    h_pred_ampt_line_48.SetMarkerColorAlpha(ROOT.kMagenta+2, 0.)

    g_pred_ampt_66.SetLineColor(ROOT.kBlue+3)
    ...
    h_pred_ampt_66.SetLineColor(ROOT.kAzure+7)
    h_pred_ampt_66.SetLineWidth(2)
    h_pred_ampt_66.SetLineStyle(1)
    h_pred_ampt_66.SetMarkerStyle(ROOT.kOpenCrossX)
    h_pred_ampt_66.SetMarkerSize(1.2)
    h_pred_ampt_66.SetMarkerColor(ROOT.kAzure+7)
    ...
    h_frame_ratio_catania.GetYaxis().SetNdivisions(606)
    ...
    h_frame_ratio_tamu.GetYaxis().SetNdivisions(606)
    ...
    h_frame_ratio_eposhq = pad_ratio_eposhq.DrawFrame(0, 0.2, 23.5,2.995, ';#it{p}_{T} (GeV/#it{c});#lower[0.09]{#frac{Data}{EPOS4HQ}}')
    ...
    h_frame_ratio_eposhq.GetYaxis().SetNdivisions(606)
    ...
    h_frame_ratio_ampt_48 = pad_ratio_ampt_48.DrawFrame(0, 0.2, 23.5,2.995, ';#it{p}_{T} (GeV/#it{c});#lower[0.09]{#frac{Data}{AMPT_{4.8}}}')
    ...
    h_frame_ratio_ampt_48.GetYaxis().SetNdivisions(606)
    ...
    h_frame_ratio_ampt_66 = pad_ratio_ampt_66.DrawFrame(0, 0.2, 23.5,2.995, ';#it{p}_{T} (GeV/#it{c});#lower[0.09]{#frac{Data}{AMPT_{6.6}}}')
    ...
    h_frame_ratio_ampt_66.GetYaxis().SetNdivisions(606)
