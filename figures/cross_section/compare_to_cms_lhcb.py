...
if __name__ == '__main__':
    ...
    h_stat.SetMarkerColor(ROOT.kBlue+3)
    h_stat.SetLineColor(ROOT.kBlue+3)
    h_stat.SetLineWidth(2)

    g_syst.SetMarkerStyle(ROOT.kFullCircle)
    g_syst.SetMarkerSize(1.5)
    g_syst.SetMarkerColor(ROOT.kBlue+3)
    g_syst.SetLineColor(ROOT.kBlue+3)
    ...
    h_frame.GetYaxis().SetTitleSize(0.035)
