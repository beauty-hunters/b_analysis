...
if __name__ == "__main__":
    ...
    text_pp = ROOT.TLatex(0.15, 0.84, 'pp collisions,#kern[0.05]{#sqrt{#it{s}} = 13.6 TeV}')
    text_pp.SetNDC()
    ...
    text_lumi = ROOT.TLatex(0.15, 0.76, '#font[132]{#it{L}}_{int} = 49.3 pb^{#minus1}')
    text_lumi.SetNDC()
